...
df = pd.read_csv('../data_EU/EU_NEET_PERC.csv')
...
df = pd.read_csv('../data_EU/EU_poverty_risk_total_PERC.csv')
...
df = pd.read_csv('../data_EU/EU_fatal_accidents_total_IR.csv')
...
df = pd.read_csv('../data_EU/EU_outside_labour_4_caring_total_PERC.csv')
