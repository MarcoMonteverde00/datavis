...
const world = await FileAttachment("./final/data_EU/countries-50m.json").json();
...
let data_year = {
  "2014": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2014_preproc.csv").csv(),
  "2015": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2015_preproc.csv").csv(),
  "2016": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2016_preproc.csv").csv(),
  "2017": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2017_preproc.csv").csv(),
  "2018": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2018_preproc.csv").csv(),
  "2019": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2019_preproc.csv").csv(),
  "2020": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2020_preproc.csv").csv(),
  "2021": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2021_preproc.csv").csv(),
  "2022": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2022_preproc.csv").csv(),
  "2023": await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_2023_preproc.csv").csv(),
};
...
```js
const rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Italy_preproc.csv").csv();
const EU_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_preproc.csv").csv();
		...
		if (event.detail.newValue != event.detail.oldValue) {
			...
			(async () => {
				if (event.detail.newValue === "Italy"){
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Italy_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
				}
				else if (event.detail.newValue === "Greece") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Greece_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
				}
				else if (event.detail.newValue === "Spain") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Spain_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "France") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_France_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Germany") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Germany_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Turkey") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Türkiye_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Poland") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Poland_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Romania") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Romania_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Netherlands") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Netherlands_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Belgium") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Belgium_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Czechia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Czechia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Portugal") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Portugal_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Sweden") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Sweden_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Hungary") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Hungary_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Austria") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Austria_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Bulgaria") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Bulgaria_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Denmark") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Denmark_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Finland") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Finland_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Slovakia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Slovakia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Ireland") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Ireland_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Croatia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Croatia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Lithuania") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Lithuania_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Slovenia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Slovenia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Latvia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Latvia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Estonia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Estonia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Cyprus") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Cyprus_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Luxembourg") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Luxembourg_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Malta") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Malta_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Iceland") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Iceland_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Switzerland") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Switzerland_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Montenegro") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Montenegro_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Serbia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Serbia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Macedonia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_North_Macedonia_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Bosnia") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Bosnia_and_Herzegovina_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else if (event.detail.newValue === "Norway") {
					confrontation_rates = await FileAttachment("./final/data_EU/preprocessed/EU_NEET_PERC_Norway_preproc.csv").csv();
					total_conf_rates = confrontation_rates.filter(row => row.sex === 'T');
					}
				else {
...
```js
const rates = await FileAttachment("./final/data_EU/preprocessed/EU_poverty_risk_total_PERC_preproc.csv").csv();
let confrontation_rates = rates;
...
```js
const rates = await FileAttachment("./final/data_EU/preprocessed/EU_fatal_accidents_total_IR_preproc.csv").csv();
let confrontation_rates = rates;
...
```js
const rates = await FileAttachment("./final/data_EU/preprocessed/EU_outside_labour_4_caring_total_PERC_preproc.csv").csv();
let confrontation_rates = rates;
